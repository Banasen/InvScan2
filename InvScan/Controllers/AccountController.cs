...
namespace InvScan.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Disassociate(string loginProvider, string providerKey)
        {
            ...
            if (result.Success)
            {
                message = "Die externe Anmeldung wurde entfernt.";
            }
            else
            {
        ...
        public async Task<ActionResult> Manage(ManageUserViewModel model)
        {
            ...
            {               
                if (ModelState.IsValid)
                {
                    ...
                    if (result.Success)
                    {
                        return RedirectToAction("Manage", new { Message = "Ihr Kennwort wurde geändert." });
                    }
                    else
                    {
                        AddErrors(result);
            ...
            {
                // Der Benutzer besitzt kein lokales Kennwort, daher werden alle Überprüfungsfehler, deren Ursache ein fehlendes Feld "OldPassword" ist, entfernt
                ...
                if (ModelState.IsValid)
                {
                    ...
                    if (result.Success)
                    {
                        return RedirectToAction("Manage", new { Message = "Ihr Kennwort wurde festgelegt." });
                    }
                    else
                    {
                        AddErrors(result);
        ...
        public async Task<ActionResult> ExternalLoginCallback(string loginProvider, string returnUrl)
        {
            ...
            // Diese externe Identität anmelden, wenn sie bereits verknüpft ist
            ...
            {
                // Verknüpfungsversuch, wenn der Benutzer bereits angemeldet ist
            ...
            {
                // Andernfalls Aufforderung, einen lokalen Benutzer zu erstellen
                ViewBag.ReturnUrl = returnUrl;
